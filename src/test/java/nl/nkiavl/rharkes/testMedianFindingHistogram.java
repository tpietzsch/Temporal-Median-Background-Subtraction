...
public class testMedianFindingHistogram {
	...
	@Test
	public void testMedianFindingHistogramBasic(){
	...
	@Test
	public void testMedianFindingHistogram1(){ //1000 initializations, one replacement in each
	...
	@Test
	public void testMedianFindingHistogram2(){ //one initialization, 1000 replacements
		//initialize histogram
		int values = 20000;
		int dataLength = 3001;
		Random generator=new Random();
