...
Note 1: The plugin also changes the original datastack. In the test case there are only 814 unique values in the image, so after the plugin runs it will contain only values between 0 and 813.
